...
from utils.camera import to_viewpoint_camera
...
class GSSTrainer(Trainer):
    def __init__(self, **kwargs):
        ...
        self.gaussRender = GaussRender(**kwargs.get('render_kwargs', {}))
...
if __name__ == "__main__":
    ...
    # :param channels: a dict {'R':[N x 1],'G':...'B'}
